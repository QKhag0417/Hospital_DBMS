INSERT INTO USERINFO (Username, Password, ID, Type) 
VALUES
('nguyenva1', 'password123', 'OP000001', 'patient'),
('tranthib2', 'pass456', 'OP000002', 'patient'),
('levanc3', 'mypassword', 'IP000003', 'patient'),
('phamthid4', 'helloWorld', 'OP000004', 'patient'),
('hoangvan5', 'securePass', 'IP000005', 'patient'),
('vuthil6', 'random123', 'OP000006', 'patient'),
('dovanm7', 'testPass', 'IP000007', 'patient'),
('buithin8', 'examplePwd', 'OP000008', 'opatient'),
('nguyenvp9', 'abc12345', 'IP000009', 'patient'),
('phamthiq10', 'secureKey', 'OP000010', 'patient'),
('nguyenth11', 'strongPass', 'OP000011', 'patient'),
('tranngcb12', 'uniquePass', 'IP000012', 'patient'),
('phamvanh13', 'qwertyui', 'OP000013', 'patient'),
('lethikl14', 'secretPwd', 'IP000014', 'patient'),
('hoangnhmq15', 'password1', 'OP000015', 'patient'),
('nguyenvan_a', 'pass12345', 'NU0001', 'nurse'),
('tranthi_b', 'secure123', 'DO0002', 'doctor'),
('levan_c', 'mypwd123', 'OT0003', 'other'),
('phamthi_d', 'strongkey', 'NU0004', 'nurse'),
('hoangvan_e', 'secret789', 'DO0005', 'doctor'),
('vuthi_f', 'randomkey', 'OT0006', 'other'),
('dovan_g', 'unique456', 'NU0007', 'nurse'),
('buithi_h', 'password1', 'DO0008', 'doctor'),
...
VALUES
('NU0001', 'Nguyễn', 'Văn', 'A',30, 'M', '0123456789', 5, 270),
('DO0002', 'Trần', 'Thị', 'B',28, 'F', '0987654321', 3, 290),
('OT0003', 'Lê', 'Văn', 'C',29, 'M', '0912345678', 4, 300),
('NU0004', 'Phạm', 'Thị', 'D',25, 'F', '0909876543', 2, 240),
('DO0005', 'Hoàng', 'Văn', 'E',35, 'M', '0988123456', 6, 220),
('OT0006', 'Vũ', 'Thị', 'F',40, 'F', '0932123456', 1, 350),
('NU0007', 'Đỗ', 'Văn', 'G',30, 'M', '0945321765', 7, 400),
('DO0008', 'Bùi', 'Thị', 'H',25, 'F', '0921765432', 5, 300),
('OT0009', 'Nguyễn', 'Văn', 'I',28, 'M', '0912654378', 3, 340),
('NU0010', 'Phạm', 'Thị', 'J',25, 'F', '0906543789', 2, 290),
('DO0011', 'Hoàng', 'Việt', 'Hùng',25, 'M','0912187656',0 , 280),
('NU0012', 'Mai', '', 'Loan',25, 'M','0912982654',0 , 320)
;
...
('OP000011', 'DO0005', 'Anxiety', '2023-11-12', '2024-12-12', 400000.00),
